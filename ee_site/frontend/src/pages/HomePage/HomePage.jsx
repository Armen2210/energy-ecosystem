      ...
      <section className="section section--summary">
        <div className="container">
          <AiSummary
              ...
              items={[
                "Выбрать продукт: БМК, БТП, ВНС, ПНС или шкафы управления.",
                "Посмотреть услуги: проектирование, строительно-монтажные работы и пусконаладка.",
                "Отправить ТЗ, проект, спецификацию или описание задачи через форму.",
              ]}
          />
        </div>
      </section>
